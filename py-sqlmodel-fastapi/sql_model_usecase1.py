...
# Make the engine
engine = create_engine("postgresql+psycopg2://postgres:postgres@10.192.250.55:5432/test_bt", future=True, echo=True)
...
#     Type = Column(String(4),  primary_key=True, unique=True)
#     PartnerType = Column(String(1))
#     EligPartnerType = Column(String(1))
#     FieldGroupSet = Column(String(4))
#     XAllowEligPartner = Column(Boolean)
#     XAllowPosting = Column(Boolean)
#     XOrgDataOptional = Column(Boolean)
#     TemplateId = Column(String(4))
#     PartnerProfile = Column(String(4))
#     PostCalendarEntries = Column(Boolean)
#     to_ContractTypeTexts = relationship("ContractTypeText",cascade="all,delete")
#     to_ConditionGroupAssignment = relationship("ConditionGroupAssignment",cascade="all,delete")
#     to_ContractTypeSection = relationship("ContractTypeSection",cascade="all,delete")

# class ContractTypeText(Base):
#     Type = Column(String(4) ,ForeignKey("contracttype.Type", ondelete='CASCADE'), primary_key=True )
#     Language = Column(String(4), primary_key=True ,default = 'E')
#     Title = Column(String(40))

# class ConditionGroupAssignment(Base):
#     Type = Column(String(4), ForeignKey("contracttype.Type", ondelete='CASCADE'), primary_key=True)
#     CndGroup = Column(String(4), ForeignKey("conditiongroup.Id",ondelete='CASCADE'),primary_key=True)

# class ContractTypeSection(Base):
#     type = Column(String(4),ForeignKey("contracttype.Type", ondelete='CASCADE'),primary_key=True)
#     section_name = Column(String(5),primary_key=True)
#     icon = Column(String(48))
